...
public class IndicationsFragment extends Fragment  {
    ...
    public static IndicationsFragment init() {
        IndicationsFragment truitonFrag = new IndicationsFragment();
        return truitonFrag;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View layoutView = inflater.inflate(R.layout.patient_indications_fragment, container,
                false);
        //Font
