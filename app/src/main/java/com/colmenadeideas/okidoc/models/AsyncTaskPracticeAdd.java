...
public class AsyncTaskPracticeAdd extends AsyncTask<String, Boolean, JSONObject> {
    ...
    public AsyncTaskPracticeAdd(Context a, String b, List<NameValuePair> c, TaskListener taskListener, String tempkey) {
        context = a;
        step = b;
        params = c;
    ...
    public JSONObject doInBackground(String... Params) {
        ...
        JSONObject response = jsonParser.getJSONObjFromUrl(config.URL + "practice/process/step/"+step+"/"+tempkey, "POST", params);
        return response;
    }
