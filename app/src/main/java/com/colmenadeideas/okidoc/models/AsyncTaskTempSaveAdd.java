...
public class AsyncTaskTempSaveAdd extends AsyncTask<String, Boolean, JSONObject> {
        ...
        public AsyncTaskTempSaveAdd(Context a, String b, String c, List<NameValuePair> d, TaskListener taskListener, String tempkey) {
            context = a;
            controller = b;
            step = c;
            params = d;
        ...
        public JSONObject doInBackground(String... Params) {
            ...
            JSONObject response = jsonParser.getJSONObjFromUrl(config.URL +controller+"/process/step/"+step+"/"+tempkey, "POST", params);
            return response;
        }
